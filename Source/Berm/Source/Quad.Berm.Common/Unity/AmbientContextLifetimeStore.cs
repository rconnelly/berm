namespace Quad.Berm.Common.Unity
{
    ...
    public abstract class AmbientContextLifetimeStore
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "UnitOfWork", Justification = "As Designed")]
